...
public extension CachedActor {
    ...
    public static func from(dto: ActorDTO, context: NSManagedObjectContext) -> CachedActor {
    ...
    public static func toDTOArray(_ actors: [CachedActor]) -> [ActorDTO] {
        return actors.map { $0.toDTO() }
    }

    /// Converts array of ActorDTO to array of CachedActor
    public static func fromDTOArray(_ dtos: [ActorDTO], context: NSManagedObjectContext) -> [CachedActor] {
